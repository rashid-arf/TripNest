...
export const BestTour: FC<Props> = ({ tripAdvisorIcon, iconAlt, tripAdvisorRating }) => {
  return (
      ...
      <div>
        <div className={styles.bestTourContent}>
          <div className={styles.bestTourContentLeft}>
            ...
            <p className={styles.bestTourContentLeftText}>
        ...
        <div className={styles.bestTourBottom}>
          <DefaultButton
            buttonText={
              <span>
                OK+
                <br />
                <span className={styles.buttonTextSmall}>Happy Traveler</span>
              </span>
            }
            className={styles.bestTourVideoButton}
          ...
          <DefaultButton
            buttonText={
              <span>
                OK+
                <br />
                <span className={styles.buttonTextSmall}>Tours Success</span>
              </span>
            }
            className={styles.bestTourVideoButton}
          ...
          <DefaultButton
            buttonText={
              <span>
                0%
                <br />
                <span className={styles.buttonTextSmall}>Positives Review</span>
              </span>
            }
            className={styles.bestTourVideoButton}
          ...
          <DefaultButton
            buttonText={
              <span>
                0<br />
                <span className={styles.buttonTextSmall}>Travel Guide</span>
              </span>
            }
            className={styles.bestTourVideoButton}
        ...
        <div className={styles.bestTourBottomCaption}>
          ...
          <div className={styles.bestTourRatingInfo}>
            {' '}
            {(tripAdvisorRating ?? 5).toFixed(1)}
            Rating out of <span className={styles.ratingNumber}>5.0</span> based on{' '}
            <span className={styles.ratingReviewsNumber}>245354 reviews</span>
          </div>
          <div className={styles.bestTourAdvisorBlock}>
            <Image
              ...
              height={24}
            />
            <div className={styles.bestTourAdvisorBlockImage} />
          </div>
