  ...
  return (
    <div className={styles.newsletterContainer}>
      <Image
        src={newsletterMask1}
        alt="newsletterMask1"
        className={styles.newsletterContentMask1}
      />
      <div className={styles.newsletterItem}>
        <DefaultButton
          buttonText={
            <span>
              <span className={styles.newsletterItemTitle}>More Inquiry</span>
              <br />
              <PhoneNumber
                phoneInfo={'+990-737 621 432'}
                className={styles.newsletterItemDescription}
              />
            </span>
          }
      ...
      <div className={styles.newsletterContent}>
        ...
        <div className={styles.newsletterContentEmailForm}>
          ...
          />
          {emailError && (
            <div className={styles.newsletterEmailErrorMessage}>
      ...
      <div className={styles.newsletterItem}>
        <DefaultButton
          buttonText={
            <span>
              <span className={styles.newsletterMailTitle}>Send Mail</span>
              <br />
      ...
      <Image
        src={newsletterMask2}
        alt="newsletterMask2"
        className={styles.newsletterContentMask2}
      />
    </div>
  );
};
