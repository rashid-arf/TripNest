    ...
    <div className={styles.FindTravelContainer}>
      <div className={styles.FindTravelContent}>
        <div className={styles.FindTravelContentLeft}>
          <DefaultTitleLink
            titleLinkText={'Testimonial'}
            classNameMask={styles.maskFindTravelLink}
            className={styles.titleFindTravelLink}
          />
          <DefaultTitleName
            titleName={'Find The Compliments From Our Travelers'}
            modifier={'white'}
          />
          <p className={styles.FindTravelContentLeftDescription}>
            Nunc volutpat sagittis cursus. Praesent sed dolor pellentesque, consectetur velon sit
            amet, pharetra ipsum. Fusce europ ultrices tortor. Praesent vehicula commodo purus at
            vulputate one of the most popular tourist place.
          </p>
        ...
        <div className={styles.FindTravelRightContent}>
          ...
          >
            {tourSelect.map((item) => (
              <SwiperSlide key={item.id} className={styles.FindTravelSlidersContent}>
                <div className={styles.FindTravelSlidersText}>
                  <p>{item.description}</p>
                  <Image
                    src={triangle}
                    alt="triangle"
                    className={styles.triangleMask}
                    width={33}
                    height={23}
                  />
      ...
      <Image
        src={FindTravelMask}
        alt={'FindTravelMask'}
        className={styles.FindTravelMask}
        width={206}
        height={328}
      />
    </div>
