  ...
  return (
    <div className={styles.TourSelectContainer}>
      <Swiper
        ...
        className={styles.TourSelectPhotos}
        modules={[Navigation]}
        {...swiperProps}
      >
        {tourSelect.map((item) => (
          <SwiperSlide key={item.id} className={styles.TourSelectSliders}>
            <div className={styles.TourSelectSlidersLeftPhoto}>
              <Image
                src={TourSelectBanner}
                alt="TourSelectBanner"
                width={536}
                height={284}
              ...
              <div className={styles.TourSelectSlidersLeftPhotoFilter}>
                <div className={styles.TourSelectSlidersLeftPhotoContent}>
                  <DefaultTitleLink
                    titleLinkText={'Savings worldwide'}
                    classNameMask={styles.maskTourSelectLink}
                    className={styles.titleTourSelectLink}
                  />
                  <DefaultDiscount titleName={'Discover Great Deal'} discount={'20% Off'} />
                  <DefaultButton
                    buttonText={'View This Trip'}
                    className={styles.tourSelectButton}
                  />
                </div>
              </div>
            </div>
            <div className={styles.TourSelectRightContent}>
              <div
                className={styles.TourSelectPhotosItem}
                ...
                <div className={styles.TourSelectSlidersPrice}>
                  <div className={styles.TourSelectSlidersPriceItem}>
                    ...
                    <div className={styles.TourSelectSlidersPriceItemDiscount}>
                      <p className={styles.TourSelectSlidersPriceItemDiscountNew}>
                        ${item.newPrice}
                      </p>
                      <p className={styles.TourSelectSlidersPriceItemDiscountOld}>
                        ${item.oldPrice}
                      </p>
                    </div>
                  </div>
                  <DefaultButton
                    ...
                    className={styles.tourSliderButton}
