      ...
      <div className={styles.whoWeAreContent}>
        ...
        <div className={styles.whoWeAreContentLabel}>
          <DefaultButton
            buttonText={
              <span className={styles.whoWeAreContentLabelText}>
                <span className={styles.title}>Worldwide Coverage</span>
                <br />
          ...
          <DefaultButton
            buttonText={
              <span className={styles.whoWeAreContentLabelText}>
                <span className={styles.title}>Competitive Pricing</span>
                <br />
                <span className={styles.description}>
            ...
            className={styles.whoWeAreLabelButton}
            iconLeft={
              <Image src={WhoWeAreCompetitive} alt="WhoWeAreCompetitive" width={65} height={70} />
            }
          />
          <DefaultButton
            buttonText={
              <span className={styles.whoWeAreContentLabelText}>
                <span className={styles.title}>Fast Booking</span>
                <br />
                <span className={styles.description}>
          ...
          <DefaultButton
            buttonText={
              <span className={styles.whoWeAreContentLabelText}>
                <span className={styles.title}>Guided Tours</span>
                <br />
                <span className={styles.description}>
                  Pellentesque venenatis egestasoi diam Proin velgorat elit porttitor metus
                  convallis.
                </span>
              </span>
            }
          ...
          <DefaultButton
            buttonText={
              <span className={styles.whoWeAreContentLabelText}>
                <span className={styles.title}>Best Support 24/7</span>
                <br />
                <span className={styles.description}>
          ...
          <DefaultButton
            buttonText={
              <span className={styles.whoWeAreContentLabelText}>
                <span className={styles.title}>Ultimate Flexibility</span>
                <br />
                <span className={styles.description}>
            ...
            className={styles.whoWeAreLabelButton}
            iconLeft={
              <Image src={WhoWeAreUltimate} alt="WhoWeAreUltimate" width={65} height={70} />
            }
          />
        </div>
      </div>
